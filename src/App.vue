...
export default {
  ...
  data() {
    return {
      ...
      projects: [
        { title: 'Invoice Reader', description: 'This project is a tool that allows you to upload invoices and other documents, and extract the data from them, saving it in a postgres database and S3.', year: '2025', link: 'https://github.com/LemosFTW/PaggoProject', tech: [DePostgresqlPlainWordmark, DeJavascriptOriginal, DeTypescriptPlain, DeReactOriginal, DeNextjsOriginalWordmark, DeNestjsOriginalWordmark, DeGitOriginal, DeDockerOriginal, DeAmazonwebservicesPlainWordmark]},
